...
function submit() {
    ...
    let validatingForm = firstNameValid && lastNameValid && emailValid && mobileValid && cityValid && zipcodeValid && stateValid && countryValid && localityValid && address1Valid && typeValid && bedroomsValid && bathroomsValid;
    if (validatingForm) {
        onLoader();
        disableEntireForms();
        blurBackground();
